...
export const Overlay = ({ 
  ...
  const getThemeName = () => {
    switch (colorTheme) {
      ...
      case ColorTheme.BLUE: return 'BLUE';
      ...
      <div className="absolute top-0 left-0 w-full p-10 flex justify-between items-start pointer-events-none z-30">
        ...
        <div className="flex gap-4 pointer-events-auto">
          ...
          <button 
            ...
            title={gestureMode ? "Turn off gesture mode" : "Turn on gesture mode (experimental) - requires webcam access"}
          >
